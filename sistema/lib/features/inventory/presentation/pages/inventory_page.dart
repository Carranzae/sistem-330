  ...
  Widget _buildSalidaTab() {
    return const Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.logout, size: 80, color: Color(0xFF9CA3AF)),
          SizedBox(height: 16),
          Text(
            'Sección de Salidas',
            style: TextStyle(
  ...
  Widget _buildDashboardTab() {
    return const Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.dashboard, size: 80, color: Color(0xFF9CA3AF)),
          SizedBox(height: 16),
          Text(
  ...
  Widget _buildPronosticosTab() {
    return const Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.analytics, size: 80, color: Color(0xFF9CA3AF)),
          SizedBox(height: 16),
          Text(
